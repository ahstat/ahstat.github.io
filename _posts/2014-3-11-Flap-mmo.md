...
Player $$3230596199$$ played many times but its skill remains more or less constant.

<strong>Comparison between <em>data20140213</em> and <em>data20140302</em>.</strong> The shape of all plots looks similar, except that in data20140302 the skill of players is greater.
...
Data:
<ul>
	<li><a href="http://ahstat.free.fr/4-flappy/data0.tar.gz" target="_blank">data20140213</a>,</li>
	<li><a href="http://ahstat.free.fr/4-flappy/data1.tar.gz" target="_blank">data20140302</a>.</li>
</ul>
Requests:
<ul>

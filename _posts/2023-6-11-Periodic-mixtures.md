...
<td align="center"><p><img src="../images/2023-6-11-Periodic-mixtures/f/linear.png" alt="todo"/></p><p>$${\scriptstyle \sigma^{-1} \left( 1- \frac{|x|}{\sigma} \right) \mathbf{1}_{|x| \leq \sigma}}$$</p></td>

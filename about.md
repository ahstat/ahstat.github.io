...
#### Episodic memory generation and evaluation benchmark for large language models (ICLR 2025) • [[paper]]({{site.baseurl}}/images/2025-llm1-iclr-paper.pdf) • [[poster]]({{site.baseurl}}/images/2025-llm1-iclr-poster.png) • [[code]](https://github.com/ahstat/episodic-memory-benchmark)
...
#### Changepoint detection via subset chains (PAKDD 2025) • [[paper]]({{site.baseurl}}/images/2025-anomaly8-pakdd-paper.pdf) • [[presentation]]({{site.baseurl}}/images/2025-anomaly8-pakdd-presentation.pdf) • [[code]](https://github.com/ahstat/scoth-segmentation)
...
#### Local evaluation of time series anomaly detection algorithms (KDD 2022) • [[paper]]({{site.baseurl}}/images/2022-anomaly1-kdd-paper.pdf) • [[poster]]({{site.baseurl}}/images/2022-anomaly1-kdd-poster.pdf) • [[code]](https://github.com/ahstat/affiliation-metrics-py)
...
#### Web QoE from encrypted traffic (IFIP Networking 2020, IEEE TNSM 2021) • [[paper]]({{site.baseurl}}/images/2020-qoe5-networking-paper.pdf) • [[poster]]({{site.baseurl}}/images/2019-qoe2-sigcomm-poster.pdf) • [[demo]](https://huawei-webqoe.shinyapps.io/sigcommdemo)
